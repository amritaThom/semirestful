...
routes['/product/new'] = 'Welcome#product_new'
routes['/product/<id>/info'] = 'Welcome#product_show'
routes['/product/<id>/edit'] = 'Welcome#product_edit'
routes['POST']['/create'] = 'Welcome#create'
routes['POST']['/product/<id>/update'] = 'Welcome#product_update'
routes['DELETE']['/product/<id>/delete'] = 'Welcome#delete'
